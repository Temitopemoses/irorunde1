  ...
  const fetchDashboardData = async (token, managedGroup) => {
    try {
      ...
      const statsResponse = await fetch(
        `https://irorunde1-production.up.railway.app//api/accounts/group-admin/stats/?group_id=${managedGroup}`,
        {
          headers: {
      ...
      const membersResponse = await fetch(
        `https://irorunde1-production.up.railway.app//api/accounts/group-admin/members/?group_id=${managedGroup}`,
        {
          headers: {
            Authorization: `Bearer ${token}`,
          },
